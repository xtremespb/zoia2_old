...
class AdminPanel extends Component {
    ...
    loadCatalog = async (language) => {
        const catalog = await import(/* webpackMode: "lazy", webpackChunkName: "i18n_user_[index]" */`../../locales/combined/user/${language}/messages.js`);
        this.setState(state => {
            const catalogs = {
                ...state.catalogs,
                [language]: catalog
    ...
    render = () => {
        ...
        return (<I18nProvider language={this.props.appData.language} catalogs={this.state.catalogs}>
            <I18n>{({ i18n }) => {
                ...
                this.props.appDataRuntimeSetDocumentTitleAction(errorMessage, this.props.appData.language);
