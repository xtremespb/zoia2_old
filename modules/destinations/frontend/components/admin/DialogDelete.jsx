        ...
        <div id={`dialogDelete_${this.props.id}`} style={{ display: 'none' }}>
            <div className="uk-modal-dialog">
                <div className="uk-modal-body">
                    <p>{this.props.i18n._(t`The following destination(s) will be permanently deleted:`)}</p>
                    <div uk-alert="true">{this.state.destinations.join(', ')}</div>
                </div>
