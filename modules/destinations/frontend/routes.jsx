...
const DestinationsList = lazy(() => import(/* webpackChunkName: "UsersList" */ './components/admin/DestinationsList.jsx'));
const DestinationsEdit = lazy(() => import(/* webpackChunkName: "UsersEdit" */ './components/admin/DestinationsEdit.jsx'));
