...
const CountriesList = lazy(() => import(/* webpackChunkName: "UsersList" */ './components/admin/CountriesList.jsx'));
const CountriesEdit = lazy(() => import(/* webpackChunkName: "UsersEdit" */ './components/admin/CountriesEdit.jsx'));
